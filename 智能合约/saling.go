...
func (t *saling) Init(stub shim.ChaincodeStubInterface) peer.Response {
	return shim.Success([]byte("牛奶销售智能合约初始化成功"))
}

// 调用智能合约的逻辑函数
func (t *saling) Invoke(stub shim.ChaincodeStubInterface) peer.Response {
